...
homeLead = [ ...
  ...
  '<p>This site shares model setup, sites, and interactive results. Select a map below.</p>' ...
];
...
content.objective = [ ...
  '<p>Short project overview, goals, and scope.</p>' ...
  '<h2 style="margin-top:1rem">How to Use This Website</h2>' ...
  '<ul>' ...
  '<li><strong>Delaware Interactive Map</strong>: browse the latest profiles and click markers to view images.</li>' ...
  '<li><strong>Duck Interactive Map</strong>: planned; coming soon.</li>' ...
  '<li><strong>Sites</strong>: quick links to locations and data sources.</li>' ...
  '</ul>' ...
];
...
'.container{display:grid;grid-template-columns:280px 1fr;gap:1rem;align-items:start;padding:1rem;max-width:1600px;margin:0 auto;min-height:calc(100vh - 140px)}', ...
...
'.feature-card img{width:100%;height:220px;object-fit:cover;display:block}', ...
