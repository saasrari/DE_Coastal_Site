...
content.objective = strjoin({ ...
  ...
  '<p><strong>Approach.</strong> We run 1D transects and refresh forcing every 4 hours from public data services (NDBC waves and NOAA CO-OPS water levels). For each cycle, 39 cross-shore profiles are simulated and compared to their initial surveyed lines.</p>' ...
